<?php get_header(); ?>
  ...
  <section class="ae-container-fluid au-pt-4 au-pb-4">
    <div class="group-buttons au-mt-2">
      ...
      <?php if($prev) : ?>
        <a href="<?php echo get_permalink( $prev->ID ); ?>" class="arrow-button arrow-button--reverse">Prev Post <div class="arrow-cont arrow-cont-rev"><svg><use xlink:href="<?php echo get_template_directory_uri(); ?>/img/symbols.svg#arrow"></use></svg></div>
        </a>
      <?php endif; ?>

      <?php if($next) : ?>
        <a href="<?php echo get_permalink($next->ID)?>" class="arrow-button">Next Post <span class="arrow-cont"><svg><use xlink:href="<?php echo get_template_directory_uri(); ?>/img/symbols.svg#arrow"></use></svg></span>
        </a>
      <?php endif; ?>

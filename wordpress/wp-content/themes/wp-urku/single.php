  ...
  <section class="ae-container-fluid ae-container-fluid--full">
    ...
    <div class="ae-container-fluid ae-container-fluid--inner rk-portfolio--inner">
      <div class="ae-grid ae-grid--collapse au-xs-ptp-1">
        ...
        <div class="ae-grid__item item-lg-6 item-lg--offset-1"><img src="<?php echo get_template_directory_uri(); ?>/img/post-inner-1.jpg" alt="Urku Portfolio"></div>
      </div>
      <div class="ae-grid ae-grid--collapse">
        <div class="ae-grid__item item-lg--auto"><img src="<?php echo get_template_directory_uri(); ?>/img/post-inner-3.jpg" alt="Urku Portfolio"></div>
      </div>
      ...
      <div class="ae-grid ae-grid--collapse">
        <div class="ae-grid__item item-lg-6"><img src="<?php echo get_template_directory_uri(); ?>/img/post-inner-2.jpg" alt="Urku Portfolio"></div>
